      ...
      <div class="collapse navbar-collapse" id="menuPrincipalColapsable">
        <div class="nav-wrap">
          ...
          <ul class="icon-list navbar-nav">
            <li class="nav-item">
              <a class="nav-link p-0" href="./pages/carrito.html" aria-label="Ver carrito"><i
                  class="bi bi-cart-fill"></i></a>
            </li>
            <li class="nav-item">
              <a class="nav-link p-0" href="./pages/login.html" aria-label="Iniciar sesión"><i
                  class="bi bi-person-circle"></i></a>
            </li>
            <li class="nav-item">
              <a class="nav-link p-0" href="./pages/login.html" aria-label="Cerrar sesión"><i
